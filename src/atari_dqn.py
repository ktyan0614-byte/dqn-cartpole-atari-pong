...
# Lab5: Value-based RL - Task 2: Vanilla DQN on Atari Pong
...
class DQNAgent:
    def __init__(self, env_name="ALE/Pong-v5", args=None):
        ...
        self.env_count = 0
        self.train_count = 0
        self.best_reward = -21  # Pong minimum
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb-run-name", type=str, default="pong-vanilla-run")
