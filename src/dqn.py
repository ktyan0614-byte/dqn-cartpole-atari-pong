...
class DQNAgent:
    ...
    def train(self):
        ...
        # Double DQN: q_net selects action, target_net evaluates it (reduces overestimation)
        ########## YOUR CODE HERE (~10 lines) ##########
        # Vanilla DQN: 直接使用 Target Network 找出最大的 Q 值
        with torch.no_grad():
            # max(1)[0] 會返回每個 batch 裡最大的 Q 值
